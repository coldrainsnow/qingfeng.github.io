...
permalink: /post/known-properties-in-csproj.html
---
...
+ `$(AutoGenerateBindingRedirects)` 设置开启或关闭绑定重定向，详情可参考：[Enable or disable autogenerated binding redirects - Microsoft Docs](https://docs.microsoft.com/en-us/dotnet/framework/configure-apps/how-to-enable-and-disable-automatic-binding-redirection)。
